...
Of course, the most important usability concern for a course explorer/scheduler is effectively \emph{finding courses}.

First, I will list some of the criteria students have for finding courses and how Skedge improves 

\subsection{Natural language search}

%Figure

See the appendix for a full list of these natural language things.
