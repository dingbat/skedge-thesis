...
I hypothesize that a combination of Skedge's presentation of information, its highly interactive user interface, and its concern for quality of user experience contribute to a sense of enjoyment regarding course scheduling. Clicking an average of five times \emph{per session} corresponds to clicking on the blocks for each of his or her courses, glancing over the details, and perhaps reading over the course description. This enamorment with one's course selection is a large component of Skedge's mission. It may seem trivial to state, but I believe the courses one takes in college are paramount to one's personal development and outlook on life. I believe ensuring that students are excited about their course selection and can also freely explore what more knowledge their university has to offer them is key to a well-balanced college experience.

The above could only be confirmed with involved user studies, which I do not have any data for. At the very least, the average block-clicks per session is a strong case for Skedge's usability over CDCS for the simple reason that Better CDCS does not even allow users to click on their schedule blocks, and this usage data shows that there is clearly a desire to do so.