...
\begin{figure}
  ...
  \caption[Course blocks in Skedge]{Hovering over a course block in Skedge's side-schedule shows at-a-glance information about it; clicking on it navigates the user to that course}
  \label{fig:courseblocks}
